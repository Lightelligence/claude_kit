...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Generate full docs/DV pack from yml2reg YAML (module or top)")
    ...
    if is_top:
        ...
        for child in top["blocks"]:
            generated.extend(_emit_module_pack(child, out_dir, targets, args.guard, not args.no_fill_gaps))
        ...
        generated.extend(_emit_module_pack(model, out_dir, targets, args.guard, not args.no_fill_gaps))

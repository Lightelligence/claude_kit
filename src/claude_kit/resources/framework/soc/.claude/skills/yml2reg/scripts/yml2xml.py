...
def generate_xml(model: dict) -> str:
    ...
    for reg in model["registers"]:
        ...
        if reg.get("description"):
            lines.append(f'      <spirit:description>{escape(reg["description"])}</spirit:description>')
    ...
    for intp in model["interrupts"]:
        ...
        if intp.get("description"):
            lines.append(f'      <spirit:description>{escape(intp["description"])}</spirit:description>')

...
Create an isolated worktree and unique task branch from the latest
...
export CLAUDE_KIT_TASK_BRANCH_PREFIX
...
worktree_root=${CLAUDE_KIT_WORKTREE_ROOT:-${CODEX_WORKTREE_ROOT:-${TMPDIR:-/tmp}/vibe_soc_tasks}}

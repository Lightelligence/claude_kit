...
**Detailed project standard (open with Read when writing or reviewing RTL — not auto-loaded):**
`.claude/references/04_verilog_coding_style.md` (M mandatory / S should / R recommend).
...
- If the design is silent, follow S.DFF / S.CRG in `.claude/references/04_verilog_coding_style.md`.

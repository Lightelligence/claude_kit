...
Read `third_party/claude_kit/src/claude_kit/resources/roles/physical-design-engineer.md`
for generic process and completion criteria. The XIN-specific contract below
takes precedence.
